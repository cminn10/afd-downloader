...
import { Loader2, Download, AlertCircle, CircleHelp } from "lucide-react"
                  ...
                  <div className="space-y-2">
                    ...
                    <Select value={tocFormat} onValueChange={setTocFormat}>
                      <SelectTrigger id="tocFormat">
                        <SelectValue
                          placeholder={dict.result.toc.placeholder}
                        />
                      </SelectTrigger>
                      <SelectContent>
                        <SelectItem value="chapter_number">
                          {dict.result.toc.number}
                        </SelectItem>
                        <SelectItem value="markdown">
                          {dict.result.toc.markdown}
                        </SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
